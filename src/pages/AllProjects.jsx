...
const AllProjects = () => {
  return (
    <div className="xl:px-[15rem] lg:px-[10rem] py-[3rem] min-h-screen text-[#efeee5]">
      ...
      <section className="">
        <div className="mb-[4rem]">
          <h1 className="text-[3rem] mb-5 relative">
            PROJECTS
            <span className="absolute bottom-0 left-0 w-[20%] h-1 bg-[#64dd50]"></span>
          </h1>

          <p className="w-[80%] text-[18px] font-light">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-8">
          {allprojects.map((project) => (
            <div key={project.id} className="">
              ...
              <p className="mt-2 text-[#babec4] text-justify">
                {project.description}
              </p>
